                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Data Motor</span>
                        ...
                        <ul id="data-motors" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ route('admin.categories.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Data Category Motor</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.merks.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Data Merk Motor</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.fuels.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Data Jenis BBM</a>
                            </li>
                        </ul>
                    </li>
                    <li>
