                ...
                <ul class="pb-2 space-y-2">
                    ...
                    <li>
                        <button type="button"
                            ...
                            aria-controls="data-motors" data-collapse-toggle="data-motors">
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>Motor Managament</span>
                        ...
                        <ul id="data-motors" class="hidden py-2 space-y-2">
                            <li>
                                <a href="{{ route('admin.categories.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Category Motor</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="{{ route('admin.fuels.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Jenis BBM</a>
                            </li>
                            <li>
                                <a href="{{ route('admin.motors.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Motor</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                        <button type="button"
                            ...
                            <span class="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item>User Managament</span>
                            <svg sidebar-toggle-item class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20"
                                xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd"
                                    d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"
                        ...
                        <ul id="dropdown-layouts" class="hidden py-2 space-y-2">
                            ...
                            <li>
                                <a href="{{ route('admin.users.index') }}"
                                    class="flex items-center p-2 text-base text-gray-900 transition duration-75 rounded-lg pl-11 group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700">Pengguna</a>
                            </li>
                            <li>
                                <a href=""
